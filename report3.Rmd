...
To do this, we built on methods developed for the Rapid Cycleway Prioritisation Tool [@lovelace_methods_2020], but using the combined network outlined above and adding additional analysis.
