...
We have developed two different methods for estimating cycle to rail stations. Both approaches follow these steps:

1) Use 2011 Census data to find journeys to work that are made by rail in Bedfordshire. In the 2011 census, the main journey mode is recorded, but secondary modes are not....Phase 1?.....

2) Using our Phase 1 or Phase 2 approach, identify which outbound rail station the journey is likely to use, and map the route from home to this station using the Cyclestreets API. 
...
Currently, the assessment of hilliness uses the average gradient across the full journey distance. Use of maximum gradient may be more appropriate, since this better reflects the limiting factor for many cyclists. 
