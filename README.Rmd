...
In Table 5 we can see the existing number of cycle racks at each station (using data from www.nationalrail.co.uk) and the potential number of cycle journeys to the station under a Go Dutch scenario in Phase 1 and Phase 2.
