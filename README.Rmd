...
read.csv("./output-data/totals.csv") %>%
...
read.csv("./output-data/s_counts_all.csv") %>%
...
read.csv("./output-data/totals_dutch.csv") %>%
...
read.csv("./output-data/s_counts_dutch.csv") %>%
