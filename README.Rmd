...
kableExtra::kable(totals,caption = "Total rail commuter journeys by Bedfordshire residents", booktabs = T)
```
...
kableExtra::kable(s_counts_all, caption = "Total rail commuter journeys departing from each mainline station", booktabs = T)
```
...
kableExtra::kable(totals_dutch,caption = "Go Dutch cycle-to-station potential for Bedfordshire residents", booktabs = T)
```
...
kableExtra::kable(s_counts_dutch,caption = "Go Dutch cycle-to-station potential for rail journeys departing from each mainline station", booktabs = T)
```
...
kableExtra::kable(racks,caption = "Existing cycle rack numbers and cycle-to-station potentials in Bedfordshire", booktabs = T)
```
