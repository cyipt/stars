...
From table X, we can see that in the Phase 1 analysis, some rail journeys are being missed. Including all rail stations, only 80% of rail journeys are accounted for, while looking solely at journeys from the ten mainline Bedfordshire stations, only 70% of Bedfordshire rail journeys are accounted for, based on 2011 Census returns. Given that under the Phase 1 method, all journeys that can be undertaken by public transport are considered, this suggests that for many current rail commutes in Bedfordshire, it is impossible to reach the station by public transport. It is likely that in the majority of cases these commuters are driving to the station.
