...
However, there is a strong overlap between the roads we find high to have cycle potential under the Go Dutch (Phase 2?) scenario, and routes that have already been proposed as candidates for new cycle routes in Luton. These include routes heading west from Leagrave station along Leagrave High Street, a route north from Leagrave station that links the station to (sustrans route xx), and a route north from Luton station that is broadly parallel to High Town Road.

In Bedford.....

Other routes that are appear to be candidates for cycle improvements according to the Phase 2 analysis include xxxx

According to the Phase 1 analysis, xx Road heading north from Luton station shows high cycle potential. As we can see in @ref/combi8, this road already benefits from a cycle track.
...
A programme of monitoring and evaluation of cycling levels is vital for the assessment of progress in raising cycle-to-station uptake. Having established baseline cycling levels across the county, the scenarios found in this report can assist the monitoring programme in terms of guiding the locations of monitoring sites (at stations or on-road) and guiding expectations for increased cycling uptake at these sites. 

Monitoring can be used to evaluate the impact of interventions. It can also feed back to suggest whether our Phase 1 or Phase 2 approach appears to better model cycling patterns in a given area, or whether changes may be needed to these models.
