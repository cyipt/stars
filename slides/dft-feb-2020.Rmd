...
```{r}
knitr::include_graphics("./air-pollution-paper.png")
```
...
- Potential cycle takeup is much higher under Phase 2: ~ 38-42%
...
```{r}
knitr::include_graphics("../figures/go-dutch-lbuzz.png")
```
...
```{r}
knitr::include_graphics("../figures/go-dutch-flitwick.png")
```
...
```{r}
knitr::include_graphics("../figures/go-dutch-abs.png")
```
...
- All mainline Bedfordshire stations could see substantial increases in cycle commuting; Luton, Leagrave and Bedford stations could all see >1200 cycle commuters
